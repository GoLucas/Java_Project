...
abstract public class Figura {
    ...
    public int zwrocWspolrzednaKolumnowaNajbardziejWysunietegoKwadracikaZPrawejStrony() {
        ...
        for (int i = 0; i < wspolrzedne.length; i++) {
            if (wspolrzedne[i][0] > najbardziej_wysunieta_wspolrzedna && wspolrzedne[i][2] != 3)
                najbardziej_wysunieta_wspolrzedna = wspolrzedne[i][0];    //szukam najbardziej wysunietej wspolrzednej z prawej strony czyli tej z najwiekszym x
        }
    ...
    public int zwrocWspolrzednaKolomnowaNajbardziejWysunietegoKwadracikaZDolu() {
        ...
        for (int i = 0; i < wspolrzedne.length; i++) {
            if (wspolrzedne[i][1] > najbardziej_wysunieta_wspolrzedna && wspolrzedne[i][2] != 3)
                najbardziej_wysunieta_wspolrzedna = wspolrzedne[i][1];    //szukam najbardziej wysunietej wspolrzednej z prawej strony czyli tej z najwiekszym x
        }
        return najbardziej_wysunieta_wspolrzedna;
    }
